...
function App() {
    ...
    return (_jsxs("div", { className: "app", children: [_jsxs("main", { className: "phone-shell", children: [_jsx("header", { className: "header", children: _jsx("h1", { children: "BANCO" }) }), error && _jsx("div", { className: "error", children: error }), loading && _jsx("div", { className: "loading", children: "Cargando..." }), page === 'list' && (_jsxs("section", { className: "list-page", children: [_jsx("div", { className: "toolbar", children: _jsx("input", { type: "text", placeholder: "Search...", value: search, onChange: (e) => setSearch(e.target.value), className: "search-input" }) }), _jsx("div", { className: "product-list", children: filteredProducts.length === 0 ? (_jsx("p", { className: "empty-cell", children: "No hay productos para mostrar" })) : (filteredProducts.map((product) => (_jsxs("button", { className: "product-item", onClick: () => handleSelectProduct(product), children: [_jsxs("div", { children: [_jsx("p", { className: "item-name", children: product.name }), _jsxs("p", { className: "item-id", children: ["ID: ", product.id] })] }), _jsx("span", { className: "item-arrow", children: "\u203A" })] }, product.id)))) }), _jsxs("div", { className: "list-footer", children: [_jsxs("p", { className: "counter", children: [filteredProducts.length, " Registros"] }), _jsx("button", { className: "btn btn-primary btn-add-main", onClick: openCreate, children: "Agregar" })] })] })), page === 'detail' && selectedProduct && (_jsx("section", { className: "detail-page", children: _jsxs("div", { className: "form-card", children: [_jsxs("h2", { children: ["ID: ", selectedProduct.id] }), _jsx("p", { className: "subtitle", children: "Informaci\u00F3n extra" }), _jsx("div", { className: "detail-logo-wrapper", children: _jsx("img", { className: "detail-logo", src: selectedProduct.logo || DEFAULT_LOGO_URL, alt: selectedProduct.name, onError: (e) => {
                                            e.target.src = DEFAULT_LOGO_URL;
                                        } }) }), _jsxs("div", { className: "detail-row", children: [_jsx("span", { children: "Nombre" }), _jsx("strong", { children: selectedProduct.name })] }), _jsxs("div", { className: "detail-row", children: [_jsx("span", { children: "Descripci\u00F3n" }), _jsx("strong", { children: selectedProduct.description })] }), _jsxs("div", { className: "detail-row", children: [_jsx("span", { children: "Logo" }), _jsx("span", {})] }), _jsxs("div", { className: "detail-row", children: [_jsx("span", { children: "Fecha liberaci\u00F3n" }), _jsx("strong", { children: selectedProduct.date_release })] }), _jsxs("div", { className: "detail-row", children: [_jsx("span", { children: "Fecha revisi\u00F3n" }), _jsx("strong", { children: selectedProduct.date_revision })] }), _jsxs("div", { className: "form-actions", children: [_jsx("button", { className: "btn btn-secondary", onClick: () => setPage('list'), children: "Volver" }), _jsx("button", { className: "btn btn-neutral", onClick: () => openEdit(selectedProduct), children: "Editar" }), _jsx("button", { className: "btn btn-danger", onClick: () => setConfirmDelete(selectedProduct), children: "Eliminar" })] })] }) })), (page === 'create' || page === 'edit') && (_jsx("section", { className: "form-page", children: _jsxs("div", { className: "form-card", children: [_jsx("h2", { children: "Formulario de Registro" }), _jsxs("div", { className: "form-grid", children: [_jsxs("label", { children: ["ID", _jsx("input", { value: form.id, disabled: page === 'edit', onChange: (e) => setForm((prev) => ({ ...prev, id: e.target.value })), className: formErrors.id ? 'input-error' : '' }), formErrors.id && _jsx("span", { className: "field-error", children: formErrors.id })] }), _jsxs("label", { children: ["Nombre", _jsx("input", { value: form.name, onChange: (e) => setForm((prev) => ({ ...prev, name: e.target.value })), className: formErrors.name ? 'input-error' : '' }), formErrors.name && _jsx("span", { className: "field-error", children: formErrors.name })] }), _jsxs("label", { children: ["Descripci\u00F3n", _jsx("input", { value: form.description, onChange: (e) => setForm((prev) => ({ ...prev, description: e.target.value })), className: formErrors.description ? 'input-error' : '' }), formErrors.description && _jsx("span", { className: "field-error", children: formErrors.description })] }), _jsxs("label", { children: ["Logo", _jsx("input", { value: form.logo, onChange: (e) => setForm((prev) => ({ ...prev, logo: e.target.value })), className: formErrors.logo ? 'input-error' : '' }), formErrors.logo && _jsx("span", { className: "field-error", children: formErrors.logo })] }), _jsxs("label", { children: ["Fecha Liberaci\u00F3n", _jsx("input", { type: "date", value: form.date_release, onChange: (e) => setForm((prev) => ({ ...prev, date_release: e.target.value })), className: formErrors.date_release ? 'input-error' : '' }), formErrors.date_release && _jsx("span", { className: "field-error", children: formErrors.date_release })] }), _jsxs("label", { children: ["Fecha Revisi\u00F3n", _jsx("input", { type: "date", value: form.date_revision, disabled: true, className: formErrors.date_revision ? 'input-error' : '' }), formErrors.date_revision && _jsx("span", { className: "field-error", children: formErrors.date_revision })] })] }), _jsxs("div", { className: "form-actions", children: [_jsx("button", { className: "btn btn-primary", disabled: saving, onClick: () => handleSave(page), children: saving ? 'Guardando...' : page === 'create' ? 'Enviar' : 'Guardar Cambios' }), _jsx("button", { className: "btn btn-neutral", onClick: resetForm, children: "Reiniciar" }), _jsx("button", { className: "btn btn-secondary", onClick: () => setPage('list'), children: "Cancelar" })] })] }) }))] }), confirmDelete && (_jsx("div", { className: "modal-overlay", onClick: () => setConfirmDelete(null), children: _jsxs("div", { className: "modal-card", onClick: (e) => e.stopPropagation(), children: [_jsx("button", { className: "modal-close", onClick: () => setConfirmDelete(null), children: "\u00D7" }), _jsxs("p", { children: ["\u00BFEst\u00E1s seguro de eliminar el producto ", confirmDelete.name, "?"] }), _jsxs("div", { className: "form-actions", children: [_jsx("button", { className: "btn btn-primary", disabled: saving, onClick: handleDelete, children: saving ? 'Eliminando...' : 'Confirmar' }), _jsx("button", { className: "btn btn-neutral", onClick: () => setConfirmDelete(null), children: "Cancelar" })] })] }) }))] }));
}
export default App;
