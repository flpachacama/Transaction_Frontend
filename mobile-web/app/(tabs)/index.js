...
const hello_wave_1 = require("@/components/hello-wave");
      ...
      <themed_view_1.ThemedView style={styles.stepContainer}>
        <expo_router_1.Link href="/modal">
          ...
          <expo_router_1.Link.Menu>
            <expo_router_1.Link.MenuAction title="Action" icon="cube" onPress={() => alert('Action pressed')}/>
            <expo_router_1.Link.MenuAction title="Share" icon="square.and.arrow.up" onPress={() => alert('Share pressed')}/>
            <expo_router_1.Link.Menu title="More" icon="ellipsis">
              <expo_router_1.Link.MenuAction title="Delete" icon="trash" destructive onPress={() => alert('Delete pressed')}/>
            </expo_router_1.Link.Menu>
          </expo_router_1.Link.Menu>
        </expo_router_1.Link>
